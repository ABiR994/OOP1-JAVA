...
public class StringDemo
{
	public static void main(String []args)
	{
		...
		System.out.println(s9);  //wolvarine

		String str10 = "Apple";
        String str11 = "Banana";

		System.out.println("compareTo result (str10.compareTo(str10)): " + str10.compareTo(str10)); //0
        System.out.println("compareTo result (str10.compareTo(str11)): " + str10.compareTo(str11)); //-1
		System.out.println("compareTo result (str11.compareTo(str10)): " + str11.compareTo(str10)); //1

        int index = str11.indexOf('n');
        System.out.println("indexOf 'n' in Banana: " + index); //2

        int indexStr = str11.indexOf("ana");
        System.out.println("indexOf 'ana' in Banana: " + indexStr); //1
